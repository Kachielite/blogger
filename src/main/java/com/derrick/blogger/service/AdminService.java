...
public interface AdminService {
    // Create user
    AuthResponseDTO createUser(RegisterRequestDTO registerRequestDTO) throws ConflictException, InternalServerErrorException;
    ...
    //Update User
    UserResponseDTO updateUser(Integer userId, UserRequestDTO userRequestDTO) throws NotFoundException, ConflictException, BadRequestException;
