...
public interface AuthenticationService {
    AuthResponseDTO login(LoginRequestDTO loginRequestDTO) throws InvalidAuthRequestException, ConflictException;

    AuthResponseDTO register(RegisterRequestDTO registerRequestDTO) throws ConflictException, InternalServerErrorException;
}
